...
- Name: fr09-coupon.spec.ts >> FR-09 — Mã giảm giá trên trang thanh toán >> BT2 [SAVE10] — C3 — đúng biên — Bằng đúng biên nên phải được chấp nhận
- Location: tests\fr09-coupon.spec.ts:447:5

# Error details

```
Error: BT2 (C3 — đúng biên) — không thấy dòng "Áp dụng thành công" dù đặc tả cho phép áp mã này. Thông báo lỗi trên màn hình: "Đơn hàng chưa đủ giá trị tối thiểu 300,000 ₫ để áp dụng mã này"
...
Call log:
  - BT2 (C3 — đúng biên) — không thấy dòng "Áp dụng thành công" dù đặc tả cho phép áp mã này. Thông báo lỗi trên màn hình: "Đơn hàng chưa đủ giá trị tối thiểu 300,000 ₫ để áp dụng mã này" with timeout 7000ms
...
- main:
  ...
  - spinbutton: "300000"
  - text: Mã Giảm Giá
  - textbox "Nhập mã giảm giá...": 23127362-BT2-20260809T104040623Z
  - button "Áp dụng"
